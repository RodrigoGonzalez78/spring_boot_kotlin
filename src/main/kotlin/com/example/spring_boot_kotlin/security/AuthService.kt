...
import com.example.spring_boot_kotlin.database.repository.RefreshTokenRepository
import com.example.spring_boot_kotlin.database.repository.UserRepository
...
class AuthService(
    ...
    fun refresh(refreshToken: String): TokenPair {
        ...
        refreshTokenRepository.findByUserIdAndHashedToken(user.id, hashedToken = hashed)
